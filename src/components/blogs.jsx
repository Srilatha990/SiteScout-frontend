...
const Blogs = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get('https://site-scout-backend.vercel.app/api/categories');
    ...
    const fetchBlogs = async () => {
      ...
      try {
        const url = selectedCategory
          ? `https://site-scout-backend.vercel.app/api/blogs/category/${selectedCategory}`
          : 'https://site-scout-backend.vercel.app/api/blogs';
